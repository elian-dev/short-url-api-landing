<script setup>
    ...
    import IGIcon from '@/assets/images/icon-instagram.svg?raw'
    ...
    <footer class="footer">
        <section class="container footer-content">
            ...
            <div class="footer-content__links">
                <ul class="links">
                    <li class="link--head">Features</li>
                    <li class="link">Link Shortening</li>
                    <li class="link">Branded Links</li>
                    <li class="link">Analytics</li>
                </ul>
                <ul class="links">
                    <li class="link--head">Resources</li>
                    <li class="link">Blog</li>
                    <li class="link">Developers</li>
                    <li class="link">Support</li>
                </ul>
                <ul class="links">
                    <li class="link--head">Company</li>
            ...
            <div class="footer-content__social">
                <span v-html="FBIcon"></span>
                <span v-html="TWIcon"></span>
                <span v-html="PTIcon"></span>
                <span v-html="IGIcon"></span>
            </div>
        </section>
    </footer>
</template>
...
.footer-content__social svg:hover{
    cursor: pointer;
}

.footer-content__social svg:hover path{
    fill: #2BD0D0;
}
